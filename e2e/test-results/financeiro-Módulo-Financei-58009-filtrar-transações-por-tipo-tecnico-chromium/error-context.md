...
- Name: financeiro.spec.ts >> Módulo Financeiro - CRUD de Transações >> deve filtrar transações por tipo
- Location: specs\financeiro.spec.ts:138:7
...
Call log:
  - waiting for locator('[data-testid="seletor-periodo"]')
      ...
      - main [ref=e132]:
        - generic [ref=e134]:
          ...
          - generic [ref=e142]:
            ...
            - button "Receita ▼" [ref=e149] [cursor=pointer]:
              - generic [ref=e150]: Receita
              - generic [ref=e151]: ▼
            - button "Todos os Status ▼" [ref=e153] [cursor=pointer]:
              - generic [ref=e154]: Todos os Status
              - generic [ref=e155]: ▼
