...
- Name: financeiro.spec.ts >> Módulo Financeiro - Visão Geral >> deve exportar CSV ao clicar no botão
- Location: specs\financeiro.spec.ts:38:7
        ...
        - generic [ref=e134]:
          ...
          - generic [ref=e142]:
            ...
            - button "Todos os Status ▼" [ref=e153] [cursor=pointer]:
              ...
              - generic [ref=e155]: ▼
            - button "Exportar CSV" [active] [ref=e156] [cursor=pointer]
          - generic [ref=e158]:
            - img [ref=e160]
